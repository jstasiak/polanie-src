...
{
VirtualScreenPtr=(unsigned char far *)farcalloc(64000L,sizeof(unsigned char));
if(VirtualScreenPtr==NULL)return 0;
		     else return 1;
}
//////////////////////////////////////////////////////////////////////
...
{
if(VirtualScreenPtr==NULL)return;
movedata(FP_SEG(VirtualScreenPtr),FP_OFF(VirtualScreenPtr)-4,0xA000,0,64000L);
}
///////////////////////////////////////////////////////////////////////////
...
{
if((Screen)&&(VirtualScreenPtr!=NULL))ActualScreenPtr=VirtualScreenPtr;
     else ActualScreenPtr=(unsigned char far *)MK_FP(0xA000,0);
}
///////////////////////////////////////////////////////////////////////////
//
//
...
//////////////////////////////////////////////////////////////////
void PutImageChange13h(int x1,int y1,void far *map,int typ,char c1,char c2)
{
unsigned int size,height,length;
...
for(i=0;i<92;i++) if(index[i]!=NULL) farfree(index[i]);
}
//--------------------------------------------------------
...
Write13h(int x,int y, int maxx, int maxdl, char *txt, int tcolour,int bcolour)
{
  ...
  { if(maxx==0)
     ...
     else Bar13h(x,y,x+maxx,y+13,bcolour);
    xp=x;
...
z=getch();
while(!(z==13))
     {if((z==' ')||(z>='0')&&(z<='z')&&((z<';')||(z>'@'))&&((z<'[')||(z>='a'))&&(li<=no))
        { *str=z; str++; li++; *str=0; *cos=z;
	 OutText13h(x, y, cos, tcolour);}
     z=getch();}
return napis;
}
