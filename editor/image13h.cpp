...
void PutImage13h(int x, int y, char *picture, int how) {
  ...
  if (!how) {
    ...
    picturePos = 6;
    for (j = 0; j < height; j++) {
      memcpy((void *)&VirtualScreen[line], (void *)&picture[picturePos],
             length);
      picturePos += length;
      line += 320;
    }
...
//
///////////////////////////////////////////////////////////////
void OpenGraphicFile() { graphicfile = fopen("graf.dat", "rb"); }
/////////////////////////////////////////////////////////////////
//
///////////////////////////////////////////////////////////////
...
//
///////////////////////////////////////////////////////////////
void OpenPaletteFile() { palettefile = fopen("pal.dat", "rb"); }
/////////////////////////////////////////////////////////////////
//
///////////////////////////////////////////////////////////////
