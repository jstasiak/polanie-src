...
void BlockKeyboard(void)
{
    ...
    cout << "\n Teraz klawiatura jest wylaczona, testowane sa jedynie porty klawiatury\n ESC - odblokowuje klawiature" << endl;
